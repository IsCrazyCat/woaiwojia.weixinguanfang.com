...
INSERT INTO `ecs_account_log` VALUES ('8','1','0.00','0.00','960','960','1242142390','订单 2009051255518 赠送的银币','99');
INSERT INTO `ecs_account_log` VALUES ('9','1','0.00','0.00','385','385','1242142432','订单 2009051298180 赠送的银币','99');
INSERT INTO `ecs_account_log` VALUES ('10','1','-2310.00','0.00','0','0','1242142549','支付订单 2009051267570','99');
INSERT INTO `ecs_account_log` VALUES ('11','1','0.00','0.00','2300','2300','1242142589','订单 2009051267570 赠送的银币','99');
...
INSERT INTO `ecs_account_log` VALUES ('19','1','0.00','0.00','-960','-960','1242144185','由于退货或未发货操作，退回订单 2009051255518 赠送的银币','99');
INSERT INTO `ecs_account_log` VALUES ('20','1','975.00','0.00','0','0','1242144185','由于取消、无效或退货操作，退回支付订单 2009051255518 时使用的预付款','99');
INSERT INTO `ecs_account_log` VALUES ('21','1','0.00','0.00','960','960','1242576445','订单 2009051719232 赠送的银币','99');
INSERT INTO `ecs_account_log` VALUES ('23','1','-13806.60','0.00','0','0','1242976699','支付订单 2009052224892','99');
INSERT INTO `ecs_account_log` VALUES ('24','1','0.00','0.00','14045','14045','1242976740','订单 2009052224892 赠送的银币','99');
INSERT INTO `ecs_account_log` VALUES ('25','1','0.00','0.00','-2300','-2300','1245045334','由于退货或未发货操作，退回订单 2009051267570 赠送的银币','99');
INSERT INTO `ecs_account_log` VALUES ('26','1','2310.00','0.00','0','0','1245045334','由于取消、无效或退货操作，退回支付订单 2009051267570 时使用的预付款','99');
INSERT INTO `ecs_account_log` VALUES ('27','1','0.00','0.00','17044','17044','1245045443','订单 2009061585887 赠送的银币','99');
INSERT INTO `ecs_account_log` VALUES ('28','1','17054.00','0.00','0','0','1245045515','1','99');
INSERT INTO `ecs_account_log` VALUES ('29','1','0.00','0.00','-17044','-17044','1245045515','由于退货或未发货操作，退回订单 2009061585887 赠送的银币','99');
...
INSERT INTO `ecs_account_log` VALUES ('32','1','0.00','0.00','1900','1900','1245048189','订单 2009061503335 赠送的银币','99');
INSERT INTO `ecs_account_log` VALUES ('33','1','0.00','0.00','-1900','-1900','1245048212','由于退货或未发货操作，退回订单 2009061503335 赠送的银币','99');
