...
class System extends Base{
	...
	{          
		/*配置列表*/
		$group_list = array('shop_info'=>'网站信息','basic'=>'基本设置','sms'=>'短信设置','shopping'=>'购物流程设置','water'=>'水印设置','distribut'=>'分销设置','logistics'=>'跑腿设置');
//		$group_list = array('shop_info'=>'网站信息','basic'=>'基本设置','sms'=>'短信设置','shopping'=>'购物流程设置','smtp'=>'邮件设置','water'=>'水印设置','distribut'=>'分销设置');
    ...
    public  function addEditNav(){                        
           ...
           $system_nav = array(
               ...
               '/index.php?m=Home&c=Goods&a=integralMall' => '银币商城',
           );           
