<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./template/mobile/new/user\order_list.html";i:1566462361;s:40:"./template/mobile/new/public\header.html";i:1566353273;s:38:"./template/mobile/new/public\menu.html";i:1491382656;}*/ ?>
<!DOCTYPE html >
<html>
<head>
	...
	<div class="order ajax_return">
       ...
       <div class="order_list">
          ...
          <div class="anniu" style="width:95%">
                ...
                <?php if($list['comment_btn'] == 1): ?><a href="<?php echo U('Mobile/User/comment_list',array('order_id'=>$list['order_id'],'store_id'=>$list['store_id'],'goods_id'=>$vo['goods_id'])); ?>">评价</a><?php endif; ?>
                <!--<?php if($list['shipping_btn'] == 1): ?><a href="http://www.kuaidi100.com/" target="_blank">查看物流</a><?php endif; ?>-->
              <?php if($list['shipping_btn'] == 1): ?><a href="<?php echo U('Mobile/User/order_shipping',array('order_id'=>$list['order_id'],'store_id'=>$list['store_id'],'goods_id'=>$vo['goods_id'])); ?>" target="_blank">查看物流</a>&nbsp;<?php endif; if($list['return_btn'] == 1): ?><a href="mqqwpa://im/chat?chat_type=wpa&uin=<?php echo $storeList[$list['store_id']]['store_qq']; ?>&version=1&src_type=web&web_src=oicqzone.com" target="_blank">联系客服</a><?php endif; ?>
          </div> 
       </div>
		<?php endforeach; endif; else: echo "" ;endif; ?>  
    </div>
