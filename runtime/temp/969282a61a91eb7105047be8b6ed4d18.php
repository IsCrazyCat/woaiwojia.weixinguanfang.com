<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./application/admin/view2/goods\ajaxGoodsList.html";i:1491382650;}*/ ?>
<table>
       <tbody>
              ...
              <tr>
                ...
                <td align="center" axis="col0">
                  <div style="text-align: center; width: 120px; max-width:120px;">
                  	...
                  	<a class="btn blue" target="_blank"  href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$list['goods_id'])); ?>"><i class="fa fa-search"></i>查看</a>
                  </div>
                </td>
                    ...
                    <div class="col-sm-3 form-inline">
                        ...
                        <input type="checkbox" onclick="$('input[name=\'goods_id\[\]\']').prop('checked', this.checked);">
                            ...
                            <select id="state_id" class="form-control" style="display: none" onchange="state_change(this);">
                                ...
                                <?php if(is_array($goods_state) || $goods_state instanceof \think\Collection): if( count($goods_state)==0 ) : echo "" ;else: foreach($goods_state as $key=>$vo): ?>
