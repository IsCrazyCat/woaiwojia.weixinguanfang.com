...
function checkSubmit(){
	...
	{
		//alert("每次最少提现额度<?php echo $tpshop_config['distribut_min']; ?>,你的账户金币<?php echo $user['user_money']; ?>");
		//return false;
	}
