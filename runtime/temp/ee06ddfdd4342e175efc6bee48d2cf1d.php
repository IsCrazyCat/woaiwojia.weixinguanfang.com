...
<div class="Wallet">
	<ul>
	<li class="bain1"><strong>￥<?php echo $user['user_money']; ?>元</strong><span>金币</span></li>
	<li class="bain1"><strong><?php echo $coupon_count; ?></strong><span>优惠券</span></li>
	<li><strong><?php echo $user['pay_points']; ?></strong><span>银币</span></li>
	</ul>
...
<div class="Wallet">
	...
	<a href="<?php echo U('User/points'); ?>"><em class="Icon Icon6"></em><dl class="b"><dt>我的银币</dt><dd>&nbsp;</dd></dl></a>
