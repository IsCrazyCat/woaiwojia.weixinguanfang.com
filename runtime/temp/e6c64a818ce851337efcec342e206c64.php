<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"./template/mobile/new/index\index.html";i:1565151624;s:40:"./template/mobile/new/public\footer.html";i:1562732638;s:44:"./template/mobile/new/public\footer_nav.html";i:1565843635;s:42:"./template/mobile/new/public\wx_share.html";i:1491382656;}*/ ?>
<!DOCTYPE html >
<html>
<head>
		...
		<ul>
			<li>
				<a href="<?php echo U('Goods/categoryList'); ?>">
					<img alt="全部分类" src="__STATIC__/images/1全部分类.png" />
					<span>全部分类</span>
				</a>
			</li>
			<li>
				<a href="<?php echo U('Index/creditCollection'); ?>">
					<img alt="店铺街" src="__STATIC__/images/2店铺街.png">
					<span>信用领</span>
				</a>
			</li>
<!--
...
-->
			<li>
				<a href="<?php echo U('Index/brand'); ?>">
					<img alt="品牌街" src="__STATIC__/images/3品牌街.png">
					<span>品牌街</span>
				</a>
			</li>
			<li>
				<a href="<?php echo U('Activity/discount_list'); ?>">
					<img alt="优惠活动" src="__STATIC__/images/4优惠活动.png">
					<span>优惠活动</span>
				</a>
			</li>		 
			<li>
				<a href="<?php echo U('Activity/group_list'); ?>">
					<img alt="团购" src="__STATIC__/images/5团购.png" />
					<span>团购</span>
				</a>
			</li>
			<li>
				<a href="<?php echo U('User/order_list'); ?>">
					<img alt="我的订单" src="__STATIC__/images/6我的订单.png">
					<span>我的订单</span>
				</a>
			</li>
			<li>
				<a href="<?php echo U('Cart/cart'); ?>">
					<img alt="购物车" src="__STATIC__/images/7购物车.png" />
					<span>购物车</span>
				</a>
			</li>
			<li>
				<a href="<?php echo U('User/index'); ?>">
					<img alt="个人中心" src="__STATIC__/images/8个人中心.png" />
					<span>个人中心</span>
				</a>
			</li>
		</ul>
...
<div class="floor_images">
	  <dl>
	    <dt>
	      <?php $pid =300;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1568797200 and end_time > 1568797200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
...
foreach($result as $key=>$v):       
    ...
    ?>        
        ...
        <dd> 
            <span class="Edge">
		      <?php $pid =301;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1568797200 and end_time > 1568797200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>            
            ...
            <span>
		      <?php $pid =302;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1568797200 and end_time > 1568797200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
	  ...
	  <ul>
	    <li class="brom">
		      <?php $pid =303;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1568797200 and end_time > 1568797200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
	    ...
	    <li>
		      <?php $pid =304;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1568797200 and end_time > 1568797200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
<div class="floor_images">
	  <dl>
        <dt>
          <?php $pid =305;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1568797200 and end_time > 1568797200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
        ...
        <dd> 
        <span class="Edge">
          <?php $pid =306;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1568797200 and end_time > 1568797200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
        ...
        <span>
          <?php $pid =307;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1568797200 and end_time > 1568797200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
	...
	<strong>
            <?php $pid =308;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1568797200 and end_time > 1568797200 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
