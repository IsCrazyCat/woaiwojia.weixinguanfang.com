<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:38:"./template/mobile/new/user\points.html";i:1565681204;s:40:"./template/mobile/new/public\header.html";i:1566353273;s:38:"./template/mobile/new/public\menu.html";i:1491382656;s:44:"./template/mobile/new/public\footer_nav.html";i:1565843635;s:42:"./template/mobile/new/public\wx_share.html";i:1491382656;}*/ ?>
<!DOCTYPE html >
<html>
<head>
...
<div id="tbh5v0">
    <div class="pbox">
        ...
        <div class="il_nav" id="J_il_nav">
            ...
            <a href="<?php echo U('User/points',array('type'=>'points')); ?>" <?php if($type == 'points'): ?>class="active"<?php endif; ?>  data-list="3">银币</a>
        </div>
        <!-- 银币导航 E -->
        ...
        -->
            <ul class="il_list all_score" id="J_il_list_1">
                ...
                <li class="list_add J_add">
                    <div class="td_l">
                        <p>金币: <?php echo $vo['user_money']; ?></p>
                        <p>银币:<?php echo $vo['pay_points']; ?></p>
                    </div>
                    <div class="td_r">
